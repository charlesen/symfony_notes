 ...
 */
final class Version20191003100332 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, is_active BOOLEAN NOT NULL, firstname VARCHAR(255) DEFAULT NULL COLLATE BINARY, bio CLOB DEFAULT NULL COLLATE BINARY, fullname VARCHAR(255) NOT NULL)');
